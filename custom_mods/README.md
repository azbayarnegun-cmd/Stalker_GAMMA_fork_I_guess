...
| [Toxic Air add-ons: economy rebalance + BigCanisters v2](Toxic%20Air/NOTES.md) | ? / own | d2026.9.6 / 2026.9.13 TEST | yes | Both replace `items_oxygentanks.ltx`; BigCanisters wins with lower prices. Base Toxic Air v2 Redux not uploaded |
