...
| [Inventory set: Squared Away, Layered Pouches, HD Icons, FIUT, Seamless Sort](SquaredAway%20+%20Addon%20Pouch%20+%20Immersive%20Inventory/NOTES.md) | ? | SA 3.1.0 / pouches 1.5.3 / FIUT 1.0.0 | yes | Partly uploaded (hit 100-file limit). HD Icons overrides 8 GAMMA scripts; load it last |
