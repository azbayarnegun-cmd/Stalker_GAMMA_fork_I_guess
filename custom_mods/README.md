...
| [Composure suite: Core, Combat, Recovery, Exploration, Consumables, Thoughts, Weapon Handling + Time-Skip, Unified Simulated Time](Composure/NOTES.md) | own mod | Core 2.1.0 (API 2) | yes | Uploaded. No conflicts. Composure Feedback (heartbeat + visuals + HUD) not uploaded yet |
