...
| [Toxic Air v2 Redux (Priler) + economy rebalance + BigCanisters v2](Toxic%20Air/NOTES.md) | ? / own | Redux / d2026.9.6 / 2026.9.13 TEST | yes | All three replace `items_oxygentanks.ltx`; BigCanisters wins with lower prices. Redux's `trader_autoinject.script` is older than GAMMA's |
