...
| [Inventory set: Squared Away, Layered Pouches, HD Icons, FIUT, Seamless Sort + own SA addons 10–95](SquaredAway%20+%20Addon%20Pouch%20+%20Immersive%20Inventory/NOTES.md) | ? / own | SA 3.1.0 / pouches 1.5.3 / addons 10–95 | yes | Squared Away, Layered Pouches, HD Icons complete. Smart Loot Routing (needed by addon 20) not uploaded. Overrides GAMMA scripts: HD Icons (8), magazine_binder, QAW MCM |
